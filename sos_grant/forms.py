    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout.append(
            Submit(
                'submit',
                'Submit',
                css_class="btn btn-lg btn-primary btn-block form-control"))
        ...
        self.helper.layout = Layout(
            ...
            Fieldset(
                ...
                PrependedText(
                    ...
                    placeholder="mm-dd-yyyy, or whatever you know"),
                'contact',
                id="conf_section", ),
            Fieldset('Tell us more', 'description'),
            Fieldset('Funding', 'acad_fund', 'ss_fund',
                     'clbr_fund', 'other_fund',
                     PrependedText('funds', '$'), 'explain'), 'proposal')
        self.helper.layout.append(
            Submit(
                'Save & Submit',
                'Save & Submit',
